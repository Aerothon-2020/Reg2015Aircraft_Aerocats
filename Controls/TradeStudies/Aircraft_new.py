...
from Aircraft_Models.Reg2014Aircraft_AeroCats.Propulsion.Aircraft_Propulsion import Propulsion #Reg2014-Reg2015 -Andrew Clemens
...
Aircraft.Alpha_Zero_CM  = 5 * ARCDEG   #for steady level flight
Aircraft.StaticMargin   = 0.10
