...
# from  Aircraft_Models.Reg2014Aircraft_AeroCats.TradeStudies.WeightTrade.Fuselage_NickSchwartz import Fuselage
from scalar.units import ARCDEG, FT, SEC, LBF, IN, OZF
...
# Aircraft.TotalWeight = 33.5 *LBF #52 to meet design criteria (190 & 100)
# #Engine Alignment
# Aircraft.EngineAlign = 1.5
# 
...
# #HTail.VC       = 0.32
# HTail.FullWing = True
# HTail.DWF      = 1.35 #Main wing Down wash factor (Typically between 1.0 (close to wing) and 2.0 (far away))
# HTail.Inverted = True
# 
...
# 
# 
Aircraft.HTailPos = 0.0
# 
# #
# # Elevator properties
# #
# HTail.Elevator.Fc = 0.5405 #corresponds to a 4" elevator
...
#==============================================================================
VTail2 = Aircraft.VTail
VTail2 = None
if VTail2 is not None:
    VTail2 = Aircraft.VTail
    ...
    VTail2.o_eff    = 0.96
    VTail_c       = 12 * IN
    VTail2.b       = 9.25 * IN #VTail Height
    VTail2.S       = VTail2.b*VTail_c
    ...
    # Rudder properties
    #
    VTail2.Rudder.Fc = 0.6625
#     VTail2.Rudder.Weight = 0.05*LBF
#     VTail2.Rudder.WeightGroup = "VTail"
...
#     VTail2.Rudder.Servo.Torque = 85*IN*OZM
...
#     VTail2.SweepFc = 1.0 - VTail2.Rudder.Fc
    ...
    # VTail2.WingWeight.LeadingEdge.WeightGroup = "VTail"
    #  
    # VTail2.WingWeight.AddSpar("TrailingEdge1", 1/16*IN, 1.75*IN, (0.25,1),1.0, False)
    ...
    # VTail2.WingWeight.TrailingEdge1.WeightGroup = "VTail"
    #  
    # VTail2.WingWeight.AddSpar("TrailingEdge2", 1/16*IN, 1.75*IN, (0.25,1),1.0, False)
    ...
    # VTail2.WingWeight.TrailingEdge2.WeightGroup = "VTail"
...
# if Aircraft.VTail2 is not None:
    ...
    VTail.o_eff    = 0.96
    # VTail.S       = 175*IN**2
    VTail.b       = 10.75 * IN # VTail Height
    VTail2_c        = 7.4 * IN
    VTail.S        = VTail.b*VTail2_c
      
    VTail.FullWing = False
    VTail.Symmetric = True
    Aircraft.VTail2Pos = 1 # Spanwise position along the HT
    Aircraft.VTail2Root = 0.572 #  VT vertical placement on HT
#       
#     VTail.Rudder.Fc = 0.67
#     VTail.Rudder.Weight = 0.05*LBF
#     VTail.Rudder.WeightGroup = "VTail2"
...
#     VTail.WingWeight.LeadingEdge.WeightGroup = "VTail2"
#   
#     VTail.WingWeight.AddSpar("TrailingEdge1", 1/16*IN, 13/8*IN, (0.25,1),1.0, False)
...
#     VTail.WingWeight.TrailingEdge1.WeightGroup = "VTail2"
#       
#     VTail.WingWeight.AddSpar("TrailingEdge2", 1/16*IN, 13/8*IN, (0.25,1),1.0, False)
...
#     VTail.WingWeight.TrailingEdge2.WeightGroup = "VTail2"
#  
# ###############################################################################
# #
# # Landing Gear
...
#     print 'Center VTail  VC       : ',AsUnit( Aircraft.VTail2.VC)
    print 'Side VTail2 VC  : ',AsUnit( Aircraft.VTail.VC) 
    
    Aircraft.Draw()
    Aircraft.WriteAVLAircraft('AVLAircraft_Latest_No_Winglets.avl')  
#      
#    VTail2.WingWeight.DrawRibs = True
#    VTail2.WingWeight.DrawDetail = True
#    VTail2.WingWeight.Draw(fig = 2)
#    VTail2.Draw(fig = 2)
#    
...
#     Aircraft.PlotCMPolars(4, (0*ARCDEG, +5*ARCDEG, +10 * ARCDEG), XcgOffsets=(+0.02, -0.02))
