...
Wing.Aileron.Fc = 0.35
Wing.Aileron.Fb = 0.45 #Need adjusted to make aileron 3% from tip
Wing.Aileron.Ft = 0.05#1 - (Wing.Fb[0] + Wing.Aileron.Fb) 
Wing.Aileron.SgnDup = -1.
Wing.Aileron.Weight = 0.01*LBF
Wing.Aileron.Servo.Fc     = 0.3
Wing.Aileron.Servo.Weight = 0.92*OZF
Wing.Aileron.Servo.Torque = 97*IN*OZM
Wing.Aileron.Servo.WeightGroup = 'Servos'
