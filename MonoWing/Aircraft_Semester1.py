...
Aircraft.TotalWeight = 33 *LBF #52 to meet design criteria (190 & 100)
#Engine Alignment
...
VTail.Rudder.Servo.Torque = 85*IN*OZM
...
if Aircraft.VTail2 is not None:
    ...
    VTail2.Rudder.Servo.Torque = 47*IN*OZM
    #Set the sweep about the rudder hinge
