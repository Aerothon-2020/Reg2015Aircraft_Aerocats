...
#HTail.VC       = 0.32
HTail.FullWing = True
HTail.DWF      = 1.525 #Main wing Down wash factor (Typically between 1.0 (close to wing) and 2.0 (far away))
HTail.Inverted = True
...
# Elevator properties
#
HTail.Elevator.Fc = 0.4706 #corresponds to a 4" elevator
...
#     Aircraft.PlotTrimmedPolars(7)
    ...
    pyl.show()
    print 'End of the script' # Added by Bo Landess to verify the script will properly terminate.
